...
export default function SellerMenu({ userName }: ProfileMenuProps) {
    ...
    <div className="h-[65vh] w-full flex items-center justify-center">
      <div className="m-3 h-full w-[25%] grid grid-cols-[4%_92%_4%] grid-rows-[4%_92%_4%]">
        <Image
          src={bg}
          alt="background"
          className="col-start-1 col-span-2 row-start-1 row-span-2 rounded-3xl w-full h-full"
        />
        ...
        >
          <div className="flex flex-col items-center justify-center mb-5 py-3 space-y-10">
            ...
            <div className="flex flex-col justify-center items-center">
              ...
              <h2 className="text-xl font-semibold text-white">Vendedor</h2>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* buttons div */}
      <div className="m-3 h-full w-[25%] flex flex-col place-content-between">
        {/* go home */}
        <div
          id="glass-bg"
