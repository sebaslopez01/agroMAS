      ...
      >
        ...
        <div className="w-full flex flex-col items-center justify-center pb-10 pt-5 space-y-5">
          ...
          <div className="w-[80%] flex flex-col space-y-3">
            ...
            <input
              className="border-gray-400 focus:outline-none focus:ring focus:ring-gray-300"
              type="email"
          ...
          <div className="w-[80%] text-sm flex justify-between">
            <div className="space-x-1 flex items-center">
              <input
                className="checked:bg-gray-500 cursor-pointer"
                type="checkbox"
              />
          ...
          <div className="w-[80%] flex justify-center space-x-2">
            ...
            <Link href="registro" className="underline text-gray-700">
              Regístrate
            </Link>
          </div>
        </div>
