        ...
        <div className="bg-[url('/background.jpg')] bg-cover bg-center h-screen">
            <div className="flex flex-col justify-evenly h-screen lg:items-end">
                ...
                <div className="flex w-[100%] flex-col items-center justify-center space-y-4 lg:w-[60%] lg:h-[40%]">
                    ...
                    <Link id="card" href="marketplace" className="w-[80%] p-3 text-xl text-white rounded-2xl text-center md:text-2xl lg:text-2xl lg:p-4 lg:w-[50%]">
                        Compra ahora
                    </Link>
                    <Link id="card" href="nosotros" className="w-[80%] p-3 text-xl text-white rounded-2xl text-center md:text-2xl lg:text-2xl lg:p-4 lg:w-[50%]">
                        Saber mas
                    </Link>
