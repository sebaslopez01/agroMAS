      ...
      <Layout>
        <div className="flex flex-col justify-center items-center w-full h-52 lg:h-72 space-y-3 bg-[url('/fondo1.png')] bg-cover p-5">
          ...
          <div className="flex justify-start w-[80%] mt-24 lg:w-[60%]">
            <h1 id="shadow" className="text-white text-3xl">
              Tienda
            </h1>
          </div>
          ...
          <div className="flex h-10 mb-3 w-[80%] lg:w-[60%]">
            <input
              id="card"
              className="w-[85%] p-5 focus:outline-none text-white placeholder-white rounded-l-full"
              placeholder="¿Qué estás buscando?"
            ></input>
            <button
              id="card"
              className="flex w-[15%] justify-center items-center border-l border-white rounded-r-full"
            >
