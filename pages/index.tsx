        ...
        <div className="flex pt-20 p-10 justify-center flex-col bg-[#ECECEA]">
          <div className="flex justify-center">
            <h2 className="text-3xl w-[80%] text-center">
              En AgroMas, contamos con dos líneas principales para apoyar el
              campo colombiano. Conócelas aquí.
            </h2>
          </div>
          ...
          <div id="destacados" className="flex h-80 p-5 m-5">
            <div className="flex justify-center content-center w-full pt-5">
              <span className="text-gray-300 text-9xl font-serif font-bold tracking-widest text-center">
                DESTACADOS
              </span>
            </div>
          </div>
          <div id="oportunities" className="flex p-10 h-fit w-full bg-[url('/prueba.jpg')] bg-cover justify-evenly">
            <CardInvest />
          </div>
        </div>
      </Layout>
